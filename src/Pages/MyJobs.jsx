...
const iteamsPerpage = 4;


  useEffect(() => {
    setIsLoading(true);
    fetch(`http://localhost:3000/myJobs/suhail@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
        setIsLoading(false);
...
const indexOfLastItem = currentPage * iteamsPerpage;
const indexOfFirstItem = indexOfLastItem - iteamsPerpage;
